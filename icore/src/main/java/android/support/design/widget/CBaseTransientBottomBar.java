 ...
 */
public abstract class CBaseTransientBottomBar<B extends CBaseTransientBottomBar<B>> {
    /**
     * Base class for {@link CBaseTransientBottomBar} callbacks.
     *
     * @param <B> The transient bottom bar subclass.
     * @see CBaseTransientBottomBar#addCallback(BaseCallback)
     */
    public abstract static class BaseCallback<B> {
        ...
        /**
         * Called when the given {@link CBaseTransientBottomBar} has been dismissed, either
         ...
         *
         * @see CBaseTransientBottomBar#dismiss()
         */
        ...
        /**
         * Called when the given {@link CBaseTransientBottomBar} is visible.
         *
         * @param transientBottomBar The transient bottom bar which is now visible.
         * @see CBaseTransientBottomBar#show()
         */
    ...
    static {
        sHandler = new Handler(Looper.getMainLooper(), new Handler.Callback() {
            ...
            public boolean handleMessage(Message message) {
                switch (message.what) {
                    case MSG_SHOW:
                        ((CBaseTransientBottomBar) message.obj).showView();
                        return true;
                    case MSG_DISMISS:
                        ((CBaseTransientBottomBar) message.obj).hideView(message.arg1);
                        return true;
                }
                return false;
            }
     ...
     */
    protected CBaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content,
    ...
    /**
     * Returns the {@link CBaseTransientBottomBar}'s context.
     */
    @NonNull
    ...
    /**
     * Returns the {@link CBaseTransientBottomBar}'s view.
     */
    @NonNull
    public View getView() {
        return mView;
    ...
    /**
     * Show the {@link CBaseTransientBottomBar}.
     */
    public void show() {
    ...
    /**
     * Dismiss the {@link CBaseTransientBottomBar}.
     */
    public void dismiss() {
    ...
    /**
     * Return whether this {@link CBaseTransientBottomBar} is currently being shown.
     */
    ...
    /**
     * Returns whether this {@link CBaseTransientBottomBar} is currently being shown, or is queued
     * to be shown next.
     */
    ...
    final SnackbarManager.Callback mManagerCallback = new SnackbarManager.Callback() {
        @Override
        public void show() {
            sHandler.sendMessage(sHandler.obtainMessage(MSG_SHOW, CBaseTransientBottomBar.this));
        }

        @Override
        public void dismiss(int event) {
            sHandler.sendMessage(sHandler.obtainMessage(MSG_DISMISS, event, 0,
                    CBaseTransientBottomBar.this));
        }
    };
    ...
    final void showView() {
        ...
        mView.setOnAttachStateChangeListener(
                new CBaseTransientBottomBar.OnAttachStateChangeListener() {
                    @Override
        ...
        if (ViewCompat.isLaidOut(mView)) {
            ...
            mView.setOnLayoutChangeListener(new CBaseTransientBottomBar.OnLayoutChangeListener() {
                @Override
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        private CBaseTransientBottomBar.OnLayoutChangeListener mOnLayoutChangeListener;
        private CBaseTransientBottomBar.OnAttachStateChangeListener mOnAttachStateChangeListener;
        ...
        void setOnLayoutChangeListener(
                CBaseTransientBottomBar.OnLayoutChangeListener onLayoutChangeListener) {
            mOnLayoutChangeListener = onLayoutChangeListener;
        }

        void setOnAttachStateChangeListener(
                CBaseTransientBottomBar.OnAttachStateChangeListener listener) {
