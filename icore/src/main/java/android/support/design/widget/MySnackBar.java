...
/**
 * MySnackbars provide lightweight feedback about an operation. They show a brief message at the
 * bottom of the screen on mobile and lower left on larger devices. MySnackbars appear above all other
 * elements on screen and only one can be displayed at a time.
 * <p>
 * They automatically disappear after a timeout or after user interaction elsewhere on the screen,
 * particularly after interactions that summon a new surface or activity. MySnackbars can be swiped
 * off screen.
 * <p>
 * MySnackbars can contain an action which is set via
...
public final class MySnackBar extends BaseTransientBottomBar<MySnackBar> {
    ...
    public static final class MySnackbarLayout extends CBaseTransientBottomBar.SnackbarBaseLayout {
        public MySnackbarLayout(Context context) {
            super(context);
        }

        public MySnackbarLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
        }
