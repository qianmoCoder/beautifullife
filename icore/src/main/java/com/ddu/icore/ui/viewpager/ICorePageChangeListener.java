...
public class ICorePageChangeListener implements ViewPager.OnPageChangeListener {

    private ArrayList<ImageView> pointViews;
    private int[] page_indicatorId;
    private ViewPager.OnPageChangeListener onPageChangeListener;

    public ICorePageChangeListener(ArrayList<ImageView> pointViews, int page_indicatorId[]) {
