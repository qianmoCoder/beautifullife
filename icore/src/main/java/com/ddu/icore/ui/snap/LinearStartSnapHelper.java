...
public class LinearStartSnapHelper extends SnapHelper {
    ...
    public View findSnapView(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager.canScrollVertically()) {
            return findLinearStartView(layoutManager, getVerticalHelper(layoutManager));
        } else if (layoutManager.canScrollHorizontally()) {
            return findLinearStartView(layoutManager, getHorizontalHelper(layoutManager));
        }
        return null;
    }
     ...
     */
    @Nullable
    private View findLinearStartView(RecyclerView.LayoutManager layoutManager,
