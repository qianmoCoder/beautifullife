...
object FragmentUtils {
    ...
    fun addFragment(fragmentManage: androidx.fragment.app.FragmentManager, fragment: androidx.fragment.app.Fragment, frameId: Int) {
        attachFragment(FRAGMENT_ADD, fragmentManage, fragment, frameId)
    }

    fun replaceFragment(fragmentManage: androidx.fragment.app.FragmentManager, fragment: androidx.fragment.app.Fragment, frameId: Int) {
        attachFragment(FRAGMENT_REPLACE, fragmentManage, fragment, frameId)
    }

    fun addToBackStackFragment(fragmentManage: androidx.fragment.app.FragmentManager, fragment: androidx.fragment.app.Fragment, frameId: Int) {
        attachFragment(FRAGMENT_ADD_TO_BACK_STACK, fragmentManage, fragment, frameId)
    }

    fun attachFragment(type: Int, fragmentManager: androidx.fragment.app.FragmentManager, fragment: androidx.fragment.app.Fragment, frameId: Int) {
        attachFragment(type, fragmentManager.beginTransaction(), fragment, frameId)
    }

    fun attachFragment(type: Int, ft: androidx.fragment.app.FragmentTransaction, fragment: androidx.fragment.app.Fragment, frameId: Int) {
