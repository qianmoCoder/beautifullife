...
/**
 * Created by yzbzz on 2019/12/5.
 */
public class TextMovementMethod extends BaseMovementMethod {

    public final String TAG = TextMovementMethod.class.getSimpleName();
    private final static int DEFAULT_COLOR_ID = R.color.c_00000000;
    ...
    public TextMovementMethod(){
        this.textViewBgColor = ICore.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = ICore.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
     ...
     */
    public TextMovementMethod(int clickableSpanBgClor){
     ...
     */
    public TextMovementMethod(int clickableSpanBgClor, int textViewBgColor){
    ...
    public boolean onTouchEvent(TextView widget, Spannable buffer,
        ...
        if(action == MotionEvent.ACTION_DOWN){
            ...
            widget.setBackgroundResource(R.color.c_00000000);
