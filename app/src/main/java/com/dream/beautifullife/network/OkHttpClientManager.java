...
public class OkHttpClientManager {
	...
	private void deliveryResult(ResultCallback callback, Request request) {
		...
		mOkHttpClient.newCall(request).enqueue(new Callback() {
			...
			public void onResponse(final Response response) {
				...
				} catch (com.google.gson.JsonParseException e)// Json瑙ｆ瀽鐨勯敊璇�
				{
					sendFailedStringCallback(response.request(), e, resCallBack);
				}
	...
	public class PostDelegate {
		...
		/**
		 * 鍚屾鐨凱ost璇锋眰:鐩存帴灏哹odyStr浠ュ啓鍏ヨ姹備綋
		 */
		...
		/**
		 * 鍚屾鐨凱ost璇锋眰:鐩存帴灏哹odyFile浠ュ啓鍏ヨ姹備綋
		 */
	...
	public class UploadDelegate {
		...
		/**
		 * 鍚屾鍩轰簬post鐨勬枃浠朵笂浼�:涓婁紶澶氫釜鏂囦欢浠ュ強鎼哄甫key-value瀵癸細涓绘柟娉�
		 */
		...
		/**
		 * 寮傛鍩轰簬post鐨勬枃浠朵笂浼�:鍗曟枃浠朵笉甯﹀弬鏁颁笂浼�
		 */
		...
		/**
		 * 寮傛鍩轰簬post鐨勬枃浠朵笂浼狅紝鍗曟枃浠朵笖鎼哄甫鍏朵粬form鍙傛暟涓婁紶
		 */
			...
			call.enqueue(new Callback() {
				...
				public void onResponse(Response response) {
					...
					try {
						...
						fos.flush();
						// 濡傛灉涓嬭浇鏂囦欢鎴愬姛锛岀涓�涓弬鏁颁负鏂囦欢鐨勭粷瀵硅矾寰�
