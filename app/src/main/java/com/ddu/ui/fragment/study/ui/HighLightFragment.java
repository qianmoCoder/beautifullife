...
import com.ddu.widget.hight.interfaces.HighLightInterface;
import com.ddu.widget.hight.position.OnBottomPosCallback;
import com.ddu.widget.hight.position.OnLeftPosCallback;
import com.ddu.widget.hight.position.OnRightPosCallback;
import com.ddu.widget.hight.position.OnTopPosCallback;
import com.ddu.widget.hight.shape.BaseLightShape;
import com.ddu.widget.hight.shape.CircleLightShape;
import com.ddu.widget.hight.shape.OvalLightShape;
import com.ddu.widget.hight.shape.RectLightShape;
import com.ddu.widget.hight.view.HightLightView;
 ...
 */
@IElement(value = "UI")
public class HighLightFragment extends DefaultFragment {
    ...
    public void showNextTipViewOnCreated() {
        mHightLight = new HighLight(getContext())//
                ...
                .setClickCallback(new HighLight.OnClickCallback() {
                    @Override
                    public void onClick() {
                        Toast.makeText(getContext(), "clicked and show next tip view by yourself", Toast.LENGTH_SHORT).show();
                        mHightLight.next();
                    }
                });
    }
