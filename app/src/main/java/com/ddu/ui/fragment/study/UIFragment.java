...
public class UIFragment extends AbstractRecycleViewFragment<ItemEntity, UIRecycleViewAdapter> implements UIRecycleViewAdapter.ItemClickListener {

    @Override
    public void initData(Bundle savedInstanceState) {

        ArrayList<Tuple<String, Class<?>>> keys = App.Companion.getElementProvider().provide("UI");
