...
public class AreaPickerViewDialog extends Dialog {
    ...
    public AreaPickerViewDialog(@NonNull Context context) {
        super(context, R.style.Dialog);
    }

    public static AreaPickerViewDialog newInstance(Context context, List<AddressBean> addressBeans) {
        AreaPickerViewDialog areaPickerDialog = new AreaPickerViewDialog(context);
