...
public class FooterView extends LoadingView {
    ...
    public FooterView(Context context, PullToRefreshScrollView pullToRefreshScrollView) {
    ...
    public View getItemView() {
        rotateLoadingLayout = new RotateLoadingLayout(mContext, PullToRefreshBase.Mode.PULL_FROM_END, mPullToRefreshScrollView.getPullToRefreshScrollDirection());
