...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ImageView> {
    ...
    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, @NonNull ImageView child, @NonNull View dependency) {
    ...
    private void maybeInitProperties(@NonNull ImageView child, @NonNull View dependency) {
